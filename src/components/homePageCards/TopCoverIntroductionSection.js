...
export default function TopCoverIntroductionSection() {
            ...
            <Grid item style={{ width: "48%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                    At **Controlsoft Limited**, we provide a comprehensive suite of **Technology, IT, Management, and Business Consulting** services designed to help organizations innovate, optimize, and lead with confidence. We partner with our clients to turn strategy into execution — combining deep industry expertise, forward-thinking technology, and actionable insight to drive meaningful business outcomes.
                  </ReactMarkdown>
                </Typography>
                <br />
                {/* <Typography variant="h5" color="textSecondary" component="p">
                  <ReactMarkdown>
                   Whether you’re transforming your digital landscape, refining operations, or positioning for sustainable growth, our multidisciplinary team delivers tailored solutions that align with your goals and deliver measurable impact.
                  </ReactMarkdown>
                </Typography> */}
              </CardContent>
            </Grid>
              ...
              <Grid item>
                <CardContent disableRipple>
                 ...
                 <br />
                  <Typography variant="h5" color="textSecondary" component="p">
                    <ReactMarkdown>
                    **From strategy to systems, and from innovation to execution — we help you build a smarter, stronger, and future-ready business.**
                    </ReactMarkdown>
                  </Typography>
                </CardContent>
              </Grid>
