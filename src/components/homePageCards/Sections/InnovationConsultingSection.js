...
import heroImage from "./../../../assets/images/controlsoft/innovation.jpg";
...
export default function InnovationConsultingSection() {
              ...
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Innovation & Emerging Technologies Services</Typography>
                     {/* <Typography style={{marginTop:0, padding: 0,fontSize:17}}>
                      ...
                      <Typography style={{marginTop:10, fontSize:15}}>
                            <ReactMarkdown>We guide businesses in exploring and adopting next-generation technologies that drive transformation and future-readiness. Our innovation experts help you harness Artificial Intelligence, IoT, Blockchain, and automation to create smarter, faster, and more connected enterprises.</ReactMarkdown>
                      </Typography>
                      <Typography style={{marginTop:30, fontSize:15}}>
                          <ReactMarkdown>By blending strategic foresight with technical expertise, we turn emerging technologies into practical solutions that redefine how your business competes and grows.</ReactMarkdown>
                    </Typography>
                      {/* <Typography style={{marginTop:30, fontSize:15}}>
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Innovation & Emerging Technologies Services</Typography>
