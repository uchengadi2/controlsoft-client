...
import heroImage from "./../../../assets/images/controlsoft/business_solutions.jpg";
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  ...
                  >
                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Business Solutions Consulting</Typography>
                    ...
                    <Typography style={{marginTop:20, fontSize:15}}>
                          <ReactMarkdown>We deliver tailored **Business Solutions Consulting** that bridges strategy, technology, and execution to drive measurable business impact. Our focus is to help organizations streamline operations, enhance customer experiences, and unlock new opportunities through intelligent, results-driven solutions. </ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:30, fontSize:15}}>
                          <ReactMarkdown>From process reengineering and enterprise system integration to performance improvement and digital business design, **we provide solutions that are practical, scalable, and aligned with your goals. Backed by deep industry expertise, we help businesses operate smarter, adapt faster, and achieve sustainable growth.**</ReactMarkdown>
                    </Typography>
                    {/* <Typography style={{marginTop:30, fontSize:15}}>
