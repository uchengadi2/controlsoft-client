...
import heroImage from "./../../../assets/images/controlsoft/it_supports.webp";
...
export default function ITServiceConsultingHeroSection() {
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  ...
                  >
                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>IT Services & Support</Typography>
                    ...
                    <Typography style={{marginTop:20, fontSize:15}}>
                          <ReactMarkdown>Our **IT Services** are designed to keep your business running seamlessly and securely. We deliver reliable, scalable, and proactive IT solutions that enhance productivity and minimize downtime. </ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:30, fontSize:15}}>
                          <ReactMarkdown>Whether managing your infrastructure, integrating systems, or providing dedicated support, we ensure your technology environment performs at its best. Backed by expertise and responsiveness, we help you focus on growth while we manage the technology that powers it.</ReactMarkdown>
                    </Typography>
                    {/* <Typography style={{marginTop:30, fontSize:15}}>
             ...
             <Grid
              ...
              >
                ...
                {/* <Typography style={{marginTop:0, padding: 70}}>
                  ...
                  >
                   <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>IT Services & Support</Typography>
