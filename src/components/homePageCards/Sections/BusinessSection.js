...
import qualityAssurance from "./../../../assets/images/controlsoft/image12.webp";
      ...
      {matchesMDUp ? (
        <>
          <Box className={classes.uppercard} disableRipple={true}>
            {/** place the grid here */}
            <Typography variant="h3" style={{marginLeft:"30%", marginBottom:50}}>Our Management Consulting Services</Typography>
            <Grid
              container
              direction="row"
            ...
            >
              ...
              >
                <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}>Business Strategy & Transformation</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                <Typography variant="h5" style={{marginLeft:60, marginBottom:20}}>Process Improvement & Operational Efficiency</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
              <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Organizational Development & Change Management</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
            ...
            >
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Performance Management & KPI Frameworks</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:2}}>Project Management & Execution Support</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Corporate Governance & Compliance Advisory</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
            ...
            >
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Cybersecurity & Risk Management</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Data Analytics & Business Intelligence</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Enterprise Software Solutions</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
        ...
        <Box className={classes.uppercardMobile} disableRipple>
            <Typography variant="h5" style={{marginLeft:"10%", fontWeight:700}}>Our Management Consulting Services</Typography>
          <Grid
            container
            direction="row"
          ...
          >
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Business Strategy & Transformation</Typography>
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Process Improvement & Operational Efficiency</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:22, fontSize:14}}>Organizational Development & Change Management</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
          ...
          >
            <Grid
              ...
              style={{ marginLeft: 10, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Performance Management & KPI Frameworks</Typography>
              {/* <CardActionArea></CardActionArea> */}
              <Grid
                container
                //direction="row"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Project Management & Execution Support</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Corporate Governance & Compliance Advisory</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
          ...
          >
            <Grid
              ...
              style={{ marginLeft: 10, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Automation & AI Integration</Typography>
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Data Engineering & Warehousing Service</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Enterprise Software Solutions</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
