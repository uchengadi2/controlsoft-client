...
import heroImage from "./../../../assets/images/controlsoft/management.webp";
...
export default function BusinessConsultingHeroSection() {
              ...
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Management Consulting</Typography>
                     {/* <Typography style={{marginTop:0, padding: 0,fontSize:17}}>
                      ...
                      <Typography style={{marginTop:10, fontSize:15}}>
                            <ReactMarkdown>We partner with organizations to unlock their full business potential through strategic management solutions. Our consultants help you redefine vision, streamline operations, and build agile structures that support growth and long-term success.</ReactMarkdown>
                      </Typography>
