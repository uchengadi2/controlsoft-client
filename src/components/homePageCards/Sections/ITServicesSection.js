...
import qualityAssurance from "./../../../assets/images/controlsoft/image16.webp";
...
export default function ITServicesSection(props) {
      ...
      {matchesMDUp ? (
        <>
          <Box className={classes.uppercard} disableRipple={true}>
            {/** place the grid here */}
            <Typography variant="h3" style={{marginLeft:"30%", marginBottom:20}}>Our IT & Support Consulting Services</Typography>
            <Grid
              container
              direction="row"
            ...
            >
              ...
              >
                <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}>Managed IT Services</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                <Typography variant="h5" style={{marginLeft:60, marginBottom:20}}>Network Infrastructure & Systems Integration</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
              <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>IT Outsourcing & Staff Augmentation</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
            ...
            >
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Disaster Recovery & Business Continuity Planning</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:2}}>Technical Support & Helpdesk Solutions</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
        ...
        <Box className={classes.uppercardMobile} disableRipple>
            <Typography variant="h5" style={{marginLeft:"10%", fontWeight:700}}>Our IT & Support Consulting Services</Typography>
          <Grid
            container
            direction="row"
          ...
          >
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Managed IT Services</Typography>
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Network Infrastructure & Systems Integration</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:22, fontSize:14}}>IT Outsourcing & Staff Augmentation</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
          ...
          >
            <Grid
              ...
              style={{ marginLeft: 10, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Disaster Recovery & Business Continuity Planning</Typography>
              {/* <CardActionArea></CardActionArea> */}
              <Grid
                container
                //direction="row"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Technical Support & Helpdesk Solutions</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
