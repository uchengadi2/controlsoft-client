...
import qualityAssurance from "./../../../assets/images/controlsoft/image7.jpg";
      ...
      {matchesMDUp ? (
        <>
          <Box className={classes.uppercard} disableRipple={true}>
            {/** place the grid here */}
            <Typography variant="h3" style={{marginLeft:"30%", marginBottom:20}}>Our Technology Consulting Services</Typography>
            <Grid
              container
              direction="row"
            ...
            >
              ...
              >
                <Typography variant="h5" style={{marginLeft:100, marginBottom:20}}>Digital Transformation Consulting</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                <Typography variant="h5" style={{marginLeft:60, marginBottom:20}}>IT Strategy & Roadmap Development</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
              <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Cloud Solutions & Migration</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
            ...
            >
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:20}}>Automation & AI Integration</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
              ...
              <Grid
                ...
                style={{ marginLeft: 20, width: "30%", marginTop: 0 }}
              >
                 <Typography variant="h5" style={{marginLeft:80, marginBottom:2}}>Data Engineering & Data Warehousing Service</Typography>
                <Grid
                  container
                  //direction="row"
                  alignItems="center"
        ...
        <Box className={classes.uppercardMobile} disableRipple>
            <Typography variant="h5" style={{marginLeft:"10%", fontWeight:700}}>Our Technology Consulting Services</Typography>
          <Grid
            container
            direction="row"
          ...
          >
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Digital Transformation Consulting</Typography>
            ...
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>IT Strategy & Roadmap Development</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:22, fontSize:14}}>Cloud Solutions & Migration</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
          ...
          >
            <Grid
              ...
              style={{ marginLeft: 10, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Cybersecurity & Risk Management</Typography>
              {/* <CardActionArea></CardActionArea> */}
              <Grid
                container
                //direction="row"
            ...
            <Grid
              ...
              style={{ marginLeft: 0, width: "30%", marginTop: 0 }}
            >
                <Typography variant="h5" style={{marginLeft:"5%", marginBottom:10, fontSize:14}}>Data Analytics & Business Intelligence</Typography>
              <Grid
                container
                //direction="row"
                alignItems="center"
