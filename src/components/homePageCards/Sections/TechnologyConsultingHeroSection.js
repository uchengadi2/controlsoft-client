...
import heroImage from "./../../../assets/images/controlsoft/texhnology.webp";
            ...
            <Box className={classes.uppercard} disableRipple={true}>
              ...
              >
                ...
                {/* <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Chauffeur-Driven Exotic Car Rentals in Lagos</Typography> */}
                  ...
                  >
                    <Typography variant="h3" style={{marginLeft:'0%',marginBottom:20}}>Technology Consulting</Typography>
                    ...
                    <Typography style={{marginTop:20, fontSize:15}}>
                          <ReactMarkdown>We help businesses harness the power of cutting-edge technology to improve efficiency, drive innovation, and accelerate growth. Our approach goes beyond implementation — we align technology with your business strategy to create solutions that deliver real, measurable results. </ReactMarkdown>
                    </Typography>
                    <Typography style={{marginTop:30, fontSize:15}}>
                          <ReactMarkdown>From digital transformation and cloud solutions to cybersecurity, automation, and data analytics, we provide end-to-end consulting that equips organizations to operate smarter and stay ahead of the curve. With the right technology strategy, we help you turn challenges into opportunities and innovation into impact.</ReactMarkdown>
                    </Typography>
                    {/* <Typography style={{marginTop:30, fontSize:15}}>
