...
import heroImage from "./../../../assets/images/controlsoft/image17.jpg";
...
export default function IndustrySpecificSolutionsHeroSection() {
              ...
              <Box className={classes.uppercard} disableRipple={true}>
                ...
                >
                  ...
                  {/* <Typography variant="h4" style={{marginLeft:'50%',marginBottom:30, fontSize:30, fontWeight:700, color:"black"}}>Airport Protocol Services</Typography> */}
                    ...
                    >
                      <Typography variant="h3" style={{marginLeft:'0%',marginBottom:30}}>Industry-Specific Solutions</Typography>
                    ...
                    <Grid
                          ...
                          >
                            ...
                            {/* <Typography style={{marginTop:0, padding: 70}}>
                              ...
                              >
                               <Typography variant="h5" style={{marginLeft:'0%',marginBottom:30, fontWeight:700}}>Industry-Specific Solutions</Typography>
