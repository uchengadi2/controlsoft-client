...
import uche from "./../../assets/images/team/uche.jpg";
import paka from "./../../assets/images/team/paka.jpg";
import taju from "./../../assets/images/team/taju.jpg";
      ...
      {matchesMDUp ? (
        <>
          <Box className={classes.uppercard} disableRipple={true}>
            {/** place the grid here */}
            <Typography variant="h3" style={{marginLeft:'40%',marginBottom:60, marginTop:20}}>Executive Management Team</Typography>
            <Grid
              container
              direction="row"
        ...
        <Box className={classes.uppercardMobile} disableRipple={true}>
            {/** place the grid here */}
            <Typography variant="h3" style={{marginLeft:'10%',marginBottom:60, marginTop:20}}>Executive Management Team</Typography>
            <Grid
              container
              direction="row"
